...
SELECT wpv.website_session_id, MIN(wpv.website_pageview_id) AS min_pageview_id
...
-- Step 2:  Bring in the landing page info for each session
...
-- SELECT * FROM sessions_with_landing_page  -- QA only
